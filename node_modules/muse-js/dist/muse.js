...
var MuseClient = (function () {
    ...
    MuseClient.prototype.connect = function (gatt) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var device, _a, service, _b, _c, telemetryCharacteristic, _d, gyroscopeCharacteristic, _e, accelerometerCharacteristic, _f, eegObservables, channelCount, _loop_1, this_1, index;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 5:
                        service = _g.sent();
                        Observable_1.Observable.fromEvent(this.gatt.device, 'gattserverdisconnected').first().subscribe(function () {
                            _this.gatt = null;
                    ...
                    case 7:
                        _c.rawControlData = (_g.sent())
                            .map(function (data) { return muse_utils_1.decodeResponse(new Uint8Array(data.buffer)); })
                            .share();
                    ...
                    case 9:
                        _d.telemetryData = (_g.sent())
                            .map(muse_parse_1.parseTelemetry);
                    ...
                    case 11:
                        _e.gyroscopeData = (_g.sent())
                            .map(muse_parse_1.parseGyroscope);
                    ...
                    case 13:
                        _f.accelerometerData = (_g.sent())
                            .map(muse_parse_1.parseAccelerometer);
                        // EEG
                        ...
                        _loop_1 = function (index) {
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        characteristicId = EEG_CHARACTERISTICS[index];
                                    ...
                                    case 2:
                                        _b.apply(_a, [(_c.sent()).map(function (data) {
                                                return {
                                                    electrode: index,
                        ...
                        _g.label = 14;
                    case 14:
                        if (!(index < channelCount)) return [3 /*break*/, 17];
                    ...
                    case 16:
                        ...
                        return [3 /*break*/, 14];
                    case 17:
                        this.eegReadings = Observable_1.Observable.merge.apply(Observable_1.Observable, eegObservables);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.controlChar.writeValue(muse_utils_1.encodeCommand('p20'))];
                    case 2:
                        // Select preset number 20
                        _a.sent();
    ...
    MuseClient.prototype.deviceInfo = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        resultListener = this.controlResponses.filter(function (r) { return !!r.fw; }).take(1).toPromise();
